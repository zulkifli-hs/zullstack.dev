...
import { ResourceGrid } from "@/components/sections/content-grids";
...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "sections.resources" });
...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const t = await getTranslations("sections.resources");
